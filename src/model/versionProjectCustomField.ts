...
*/
export class VersionProjectCustomField extends BundleProjectCustomField {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VersionProjectCustomField.attributeTypeMap);
    }
}
